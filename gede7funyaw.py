...
# 4. Stop and hold steady position for 2 seconds
...
# 6. Move forward (to the south) for 3 seconds
print("Moving forward to the east")
duration = 6
north_velocity = -0.2  # m/s
east_velocity = 0
...
# 7. Move forward (to the west) for 3 seconds
print("Moving forward to the east")
duration = 6
north_velocity = 0  # m/s
east_velocity = -0.2
...
# Rotate clockwise continuously at 30 degrees per second for 3 seconds
set_yaw_rate(720, 3)

# Rotate counterclockwise continuously at 45 degrees per second for 5 seconds
set_yaw_rate(-1500, 12)
